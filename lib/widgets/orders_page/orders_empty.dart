  ...
  Widget build(BuildContext context) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
      Container(
        ...
        decoration: BoxDecoration(
            image: DecorationImage(
                fit: BoxFit.fill,
                image: AssetImage('assets/img/pages/order_food.png'))),
      ),
      Padding(
          padding: const EdgeInsets.all(3.0),
          child: Text('Aún no haz hecho mandados',
      ...
      Padding(
        ...
        child: Text(
            'Parece que no haz realizado ningún mandado, recuerda que hoy toca hacer la despensa',
            textAlign: TextAlign.center,
            style: TextStyle(
